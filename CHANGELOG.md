...
Все значимые изменения в проекте VPS Security Initial Setup документируются в этом файле.
...
- Обновленная документация:
  ...
  - `docs/vps-security-initial-setup.md` — документация по настройке VPS
...
### Изменено
- Рефакторинг главного скрипта `vps-security-setup.sh`
...
### Добавлено
- Первоначальная структура проекта VPS Security Initial Setup
- Главный скрипт `vps-security-setup.sh` с базовым меню
